...
from gittip.billing.exchanges import ach_credit, capture_card_hold, create_card_hold, upcharge
...
class Payday(object):
    ...
    def create_card_holds(self, cursor):
        ...
        holds = balanced.CardHold.query.filter(is_void=False).all()
        holds = {h['meta']['participant_id']: h for h in holds}
